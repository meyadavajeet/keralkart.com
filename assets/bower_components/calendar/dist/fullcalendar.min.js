...
!function(t) {
    ...
    function ut(n, i, r) {
        ...
        return e.isMoment(u) || U(u) || void 0 === u ? a = e.apply(null, n) : (s = !1,
        o = !1,
        c ? te.test(u) ? (u += "-01",
        n = [u],
        s = !0,
        o = !0) : (l = ee.exec(u)) && (s = !l[5],
        o = !0) : t.isArray(u) && (o = !0),
    ...
    function ft(t, e) {
        var n, i;
        return "string" == typeof e ? e : (n = e.token) ? se[n] ? se[n](t) : ct(t, n) : e.maybe && (i = ht(t, e.maybe),
        i.match(/[1-9]/)) ? i : ""
    }
    ...
    function pt(t, e, n, i, r) {
        ...
        for (o = 0; o < n.length && (s = vt(t, e, u, c, n[o]),
        s !== !1); o++)
            d += s;
        for (l = n.length - 1; l > o && (s = vt(t, e, u, c, n[l]),
        s !== !1); l--)
            h = s + h;
        for (a = o; a <= l; a++)
            f += ft(t, n[a]),
    ...
    function vt(t, e, n, i, r) {
        var s, o;
        return "string" == typeof r ? r : !!((s = r.token) && (o = oe[s.charAt(0)],
        o && n.isSame(i, o))) && ct(t, s)
    }
    function mt(t) {
    ...
    function Dt(t) {
        ...
        var n = [];
        this.add = "number" == typeof t ? at(e, t) : e,
        this.addQuickly = e
    }
    function Tt(t, e) {
        ...
        function o(i) {
            ...
            return s && t.each(s.split(" "), function(n) {
                ...
                t.each(this.split(","), function(n, i) {
                    ...
                    o = !1) : ((r = (e.options.customButtons || {})[i]) ? (a = function(t) {
                        r.click && r.click.call(m[0], t)
                    }
                    ,
                    u = "",
                    c = r.text) : (l = e.getViewSpec(i)) ? (a = function() {
                        e.changeView(i)
                    }
                    ,
                    v.push(i),
                    u = l.buttonTextOverride,
                    c = l.buttonTextDefault) : e[i] && (a = function() {
                        e[i]()
                    }
                    ,
                    u = (e.overrides.buttonText || {})[i],
                    c = e.options.buttonText[i]),
                    a && (d = r ? r.themeIcon : e.options.themeButtonIcons[i],
                    h = r ? r.icon : e.options.buttonIcons[i],
                    f = u ? tt(u) : d && e.options.theme ? "<span class='ui-icon ui-icon-" + d + "'></span>" : h && !e.options.theme ? "<span class='fc-icon fc-icon-" + h + "'></span>" : tt(c),
                    g = ["fc-" + i + "-button", p + "-button", p + "-state-default"],
                    m = t('<button type="button" class="' + g.join(" ") + '">' + f + "</button>").click(function(t) {
                        m.hasClass(p + "-state-disabled") || (a(t),
    ...
    function _t(n, i) {
        ...
        function o() {
            ...
            _.options.handleWindowResize && (K = at(v, _.options.windowResizeDelay),
            t(window).resize(K))
        }
        function l() {
            Q && Q.removeElement(),
        ...
        function u(e, n) {
            ...
            i && (F(),
            c()),
            !Q && e && (Q = _.view = et[e] || (et[e] = _.instantiateView(e)),
            Q.setElement(t("<div class='fc-view fc-" + e + "-view' />").appendTo(q)),
            W.proxyCall("activateButton", e)),
            Q && (J = Q.massageCurrentDate(J),
            Q.isDateSet && J >= Q.intervalStart && J < Q.intervalEnd || a() && (n && Q.captureInitialScroll(n),
            Q.setDate(J, n),
            n && Q.releaseScroll(),
            D())),
            i && N(),
        ...
        function E() {
            U.setToolbarOptions(S()),
            U.render(),
            U.el && n.prepend(U.el)
        }
        function b() {
            j.setToolbarOptions(w()),
            j.render(),
            j.el && n.append(j.el)
        }
        function D() {
        ...
        function H() {
            J = Q.computePrevDate(J),
            u()
        }
        function R() {
            J = Q.computeNextDate(J),
            u()
        }
        function x() {
            J.add(-1, "years"),
        ...
        function V(t) {
            ...
            if (1 === n) {
                ...
                if ("defaultDate" === e)
                    return;
                if ("businessHours" === e)
                    return void (Q && (Q.unrenderBusinessHours(),
                    Q.renderBusinessHours()));
                if ("timezone" === e)
                    return _.rezoneArrayEventSources(),
                    void _.refetchEvents()
            }
            E(),
            b(),
            et = {},
        ...
        _.bindOptions(["locale", "monthNames", "monthNamesShort", "dayNames", "dayNamesShort", "firstDay", "weekNumberCalculation"], function(t, e, n, i, s, o, l) {
            ...
            "ISO" !== l && "local" !== l && "function" != typeof l || (Y._fullCalendar_weekCalc = l),
            J && r(J)
        }),
        ...
        _.moment = function() {
            var t;
            return "local" === _.options.timezone ? (t = qt.moment.apply(null, arguments),
            t.hasTime() && t.local()) : t = "UTC" === _.options.timezone ? qt.moment.utc.apply(null, arguments) : qt.moment.parseZone.apply(null, arguments),
            r(t),
            t
        }
        ,
        ...
        _.getDefaultEventEnd = function(t, e) {
            var n = e.clone();
            return t ? n.stripTime().add(_.defaultAllDayEventDuration) : n.add(_.defaultTimedEventDuration),
    ...
    function Ut() {
        ...
        function i() {
            $ = r(nt),
            U.trigger("eventsReset", $)
        }
        function r(t) {
            var e, n, i = [];
            for (e = 0; e < t.length; e++)
                n = t[e],
                n.start.clone().stripZone() < Z && U.getEventEnd(n).stripZone() > q && i.push(n);
            return i
        }
        function s(t, e) {
            return !q || t < q || e > Z
        ...
        function u(t, e) {
            var n, i;
            for ("reset" === e ? nt = [] : "add" !== e && (nt = C(nt, t)),
            n = 0; n < t.length; n++)
                i = t[n],
        ...
        function h() {
            et--,
            et || (i(nt),
            U.trigger("eventsReceived", $))
        }
        function f(e, n) {
            var i, r, s = qt.sourceFetchers;
            for (i = 0; i < s.length; i++) {
                if (r = s[i].call(U, e, q.clone(), Z.clone(), U.options.timezone, n),
                r === !0)
                    return;
                if ("object" == typeof r)
                    return void f(r, n)
        ...
        function B(e) {
            return t.isFunction(e) ? t.grep(nt, e) : null != e ? (e += "",
    ...
    t.fn.fullCalendar = function(e) {
        ...
        return this.each(function(r, s) {
            ...
            r || (i = o),
            "destroy" === e && l.removeData("fullCalendar")) : a || (a = new De(l,e),
      ...
      , me = qt.Grid = St.extend(ce, de, {
        ...
        getDayClasses: function(t, e) {
            var n = this.view
              , i = n.calendar.getNow()
              , r = ["fc-" + Xt[t.day()]];
            return 1 == n.intervalDuration.as("months") && t.month() != n.intervalStart.month() && r.push("fc-other-month"),
            t.isSame(i, "day") ? (r.push("fc-today"),
            e !== !0 && r.push(n.highlightStateClass)) : t < i ? r.push("fc-past") : r.push("fc-future"),
            r
        }
    });
    me.mixin({
        ...
        handleSegTouchStart: function(t, e) {
            ...
            u || !l && !a || (i = r.opt("eventLongPressDelay"),
    ...
    var ye = qt.DayTableMixin = {
        ...
        renderHeadDateCellHtml: function(t, e, n) {
            ...
            return 1 === this.rowCnt ? r = r.concat(this.getDayClasses(t, !0)) : r.push("fc-" + Xt[t.day()]),
            '<th class="' + r.join(" ") + '"' + (1 === this.rowCnt ? ' data-date="' + t.format("YYYY-MM-DD") + '"' : "") + (e > 1 ? ' colspan="' + e + '"' : "") + (n ? " " + n : "") + ">" + i.buildGotoAnchorHtml({
                date: t,
    ...
    var Ee = qt.View = St.extend(ue, ce, {
        ...
        executeDateRender: function(t) {
            var e = this;
            return t ? this.captureInitialScroll() : this.captureScroll(),
            this.freezeHeight(),
    ...
    var De = qt.Calendar = St.extend({
        ...
        buildViewSpecButtonText: function(t, e) {
            ...
            t.buttonTextDefault = n(this.localeDefaults) || n(this.dirDefaults) || t.defaults.buttonText || n(De.defaults) || (t.duration ? this.humanizeDuration(t.duration) : null) || e
        },
      ...
      , Ve = me.extend({
        ...
        renderSegList: function(e) {
            ...
            for (n = 0; n < s.length; n++)
                if (i = s[n])
                    for (l.append(this.dayHeaderHtml(this.view.start.clone().add(n, "days"))),
        ...
        fgSegHtml: function(t) {
            ...
            o && i.push("fc-has-url"),
            '<tr class="' + i.join(" ") + '">' + (this.displayEventTime ? '<td class="fc-list-item-time ' + n.widgetContentClass + '">' + (e || "") + "</td>" : "") + '<td class="fc-list-item-marker ' + n.widgetContentClass + '"><span class="fc-event-dot"' + (r ? ' style="background-color:' + r + '"' : "") + '></span></td><td class="fc-list-item-title ' + n.widgetContentClass + '"><a' + (o ? ' href="' + tt(o) + '"' : "") + ">" + tt(t.event.title || "") + "</a></td></tr>"
        }
    });
    return Zt.list = {
        class: Ae,
