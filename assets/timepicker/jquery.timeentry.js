 	...
 	return newTime;
		...
		/** Default settings for the plugin.
			...
			@property [maxTime=null] {Date|number|string|number[]} The latest selectable time,
						or <code>null</code> for no limit. See <code>defaultTime</code> for possible formats,
						use array of hours, minutes, seconds for <code>unlimitedHours</code>.
			@property [spinnerImage="<?= base_url('/assets/timepicker/spinnerDefault.png'); ?>"] {string} The URL of the images to use for the time spinner -
		...
		defaultOptions: {
			...
			minTime: null,
			maxTime: null,
			spinnerImage: "<?= base_url().'/assets/timepicker/spinnerDefault.png' ?>",
			spinnerSize: [20, 20, 8],
			spinnerBigImage: '',
