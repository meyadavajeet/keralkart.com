                ...
                <form class="form-horizontal" id="incomeForm" name="myForm" method="post"
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <input type="hidden" value="<?php echo $productsList->id;?>" name="productID">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control" id="subCategoryId" name="subcategory">
                                    <option value="<?=$productsList->subcategoryId;?>">
                                        <?=$productsList->subCategoryName?>
                                    </option>
                                </select>
                            </div>
                        </div>
...
<!--                        </div>-->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="number" value="<?php echo $productsList->discount;?>" class="form-control"
                                    id="" placeholder="in %" name="discount">
                            </div>
                        </div>
...
<!--                        </div>-->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="color" value="<?php echo $productsList->color;?>" class="form-control"
                                    id="" name="color">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" value="<?php echo $productsList->size;?>" class="form-control" id=""
                                    name="size">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="number" value="<?php echo $productsList->weight;?>" class="form-control"
                                    id="" name="weight">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select name="latestCollection" class="form-control">
                                    <option value="">Select Options</option>
                                    <?php 
                                if ($productsList->prd_status=='1') {
                                    ?><option selected="" value="1">Yes</option>
                                    <option value="0">No</option><?php
                                }
                                elseif($productsList->prd_status=='0'){
                                    ?><option selected="" value="0">No </option>
                                    <option value="1">Yes</option><?php
                                }else{
                                    ?>
                    ...
                    <div class="box-footer">
                        ...
                        <a href="<?= base_url() ?>product-list"><button type="button"
                                class="btn btn-danger pull-right">Back To List</button></a>
