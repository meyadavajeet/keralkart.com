...
<div class="container">
	...
	<div class="sucs_box">
		...
		<h4>Sorry Some Issue Please try after sometime</h4>
	...
	<div class="margin-50 clearfix">
			        ...
			        <div class="cr_tab clearfix">
			            ...
			            <div class="col-sm-9 col-xs-12"> 
			                    <div class="clearfix cr-info">
			                        ...
			                        <span>QTY :  <input type="number" id="qtyId<?=$i?>" value="<?=$items['qty']?>" max="10" min="1" name="" style="width: 50px" readonly></span>
		...
		<div class="col-md-4 col-sm-5 col-xs-12">
			...
			<div class="second-div clearfix">
				...
				<p>Delivery expected by wednesday 13 June 2018</p>
			</div>
			<p class="cncl"><a href="#">Cancel items(s)</a></p>
			</div>
		</div>
	</div>
